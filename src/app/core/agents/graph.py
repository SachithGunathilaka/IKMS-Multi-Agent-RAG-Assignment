...
def create_qa_graph() -> Any:
    ...
    1. Planning Agent: Decomposes the question into sub-queries
...
def run_qa_flow(question: str) -> Dict[str, Any]:
    ...
    1. Initializes the graph state with the question and planning fields
    ...
    Returns:
        ...
        - `plan`: The search strategy generated by the planner
        - `sub_questions`: The decomposed queries used for retrieval
    """
    graph = get_qa_graph()
