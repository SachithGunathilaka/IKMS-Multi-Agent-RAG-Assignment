...
- **Strategic Search**: You are encouraged to call the tool multiple times with 
  different query variations if the initial results are insufficient or if the 
  sub-question is broad.
- Use the provided Search Plan and Original Question to guide your tool usage.
